...
- **Resizing a week keeps the days already set up.** `changeCount()` used to replace everything with defaults. A day added by growing takes the latest free weekday the new schedule offers and shrinking drops from the end, so 2 to 4 and back to 2 returns the week you had.
